...
const Education = () => {
  ...
  return (
    <section id="education" className="py-16 md:py-24 bg-white" ref={ref}>
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="absolute left-6 sm:left-8 lg:left-1/2 transform lg:-translate-x-0.5 top-0 bottom-0 w-0.5 bg-gray-200">
              <motion.div
