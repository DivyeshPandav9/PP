  ...
  const projects = [
    {
      ...
      description: "Modern e-commerce solution with seamless shopping experience and advanced product management.",
      fullDescription: "A comprehensive e-commerce platform featuring advanced product filtering, real-time inventory management, secure payment processing with Stripe, user authentication with JWT, and a powerful admin dashboard for managing products, orders, and customers. Built with performance optimization and SEO best practices.",
    ...
    },
    {
      ...
      description: "Collaborative workspace with real-time updates and intuitive drag-and-drop functionality.",
      fullDescription: "A full-featured task management application with real-time collaboration, drag-and-drop task organization, team workspaces, time tracking, file attachments, and comprehensive reporting. Features WebSocket integration for live updates and a responsive design that works seamlessly across all devices.",
    ...
    },
    {
      ...
      fullDescription: "An elegant weather dashboard providing detailed forecasts, interactive weather maps, historical data analysis, and personalized weather alerts. Features geolocation services, multiple city tracking, and beautiful data visualizations with Chart.js integration.",
    ...
    },
    {
      ...
      description: "Responsive portfolio showcasing modern design principles with smooth animations.",
      fullDescription: "A modern, responsive portfolio website featuring smooth animations, interactive elements, and optimized performance. Built with React, Framer Motion for animations, and Tailwind CSS for styling. Includes contact form integration, SEO optimization, and accessibility features.",
    ...
    },
    {
      ...
      description: "Secure financial dashboard with real-time analytics and transaction management.",
      fullDescription: "A comprehensive banking dashboard featuring account management, transaction history, budget tracking, and financial analytics. Built with security-first principles, including two-factor authentication and encrypted data transmission.",
    ...
    },
    {
      ...
      fullDescription: "A feature-rich social media application with real-time messaging, photo sharing, story features, and advanced privacy controls. Includes push notifications, offline support, and seamless mobile experience.",
                ...
                <div className="flex flex-wrap gap-3 mb-10">
                  {selectedProject.technologies.map((tech: string, index: number) => (
                    <motion.span
                      ...
                      className={`px-4 py-2 text-sm font-medium rounded-full border ${getTechColor(tech)}`}
                    >
                      {tech}
                    </motion.span>
                  ))}
