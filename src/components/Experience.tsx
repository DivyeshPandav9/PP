...
const Experience = () => {
  ...
  const getTechColor = (tech: string) => {
    const colors: { [key: string]: string } = {
      ...
      'SCSS': 'bg-pink-50 text-pink-700 border-pink-200',
      'Bootstrap': 'bg-purple-50 text-purple-700 border-purple-200',
      'Webpack': 'bg-blue-50 text-blue-600 border-blue-200',
      'jQuery': 'bg-blue-50 text-blue-600 border-blue-200',
      'Git': 'bg-gray-50 text-gray-700 border-gray-200'
    };
    return colors[tech] || 'bg-gray-50 text-gray-700 border-gray-200';
  };

  return (
    <section id="experience" className="py-24 bg-gray-50/50" ref={ref}>
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              My professional journey in frontend development, building impactful solutions and growing with amazing teams.
            </motion.p>
          </motion.div>
          ...
          >
            {experienceData.map((experience, index) => (
              <motion.div
                ...
                className="relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:border-gray-200 transition-all duration-300 overflow-hidden"
              >
                ...
                {experience.current && (
                  ...
                  >
                    <div className="flex items-center gap-2 px-3 py-1 bg-green-100 text-green-700 text-sm font-medium rounded-full border border-green-200">
                      ...
                      <ul className="space-y-3">
                        {experience.achievements.map((achievement, achievementIndex) => (
                          <motion.li
                            ...
                            initial={{ opacity: 0, x: -20 }}
                            animate={isInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -20 }}
                            transition={{ duration: 0.5, delay: index * 0.15 + 1.1 + achievementIndex * 0.1 }}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {experience.technologies.map((tech, techIndex) => (
                          <motion.span
                            ...
                            transition={{ duration: 0.4, delay: index * 0.15 + 1.5 + techIndex * 0.05 }}
